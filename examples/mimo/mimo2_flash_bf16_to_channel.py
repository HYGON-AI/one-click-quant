...
def main(input_path, output_path, quant_type):
    ...
    # ignore_layers = config["quantization_config"]["ignore_layers"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input-path", type=str, default="/workspace/models/MiMo-V2-Flash-bf16-fix")
    parser.add_argument("--output-path", type=str, default="/module/MiMo-V2-Flash-channel-int8-rtn")
